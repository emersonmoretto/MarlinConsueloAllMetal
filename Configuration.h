...
#define STRING_CONFIG_H_AUTHOR "(emoretto, Consuelo All-metal w/ Z-endstop)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Consuelo"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 4000, 185 }
